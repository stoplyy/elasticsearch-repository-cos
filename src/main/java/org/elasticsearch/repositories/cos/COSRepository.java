...
public class COSRepository extends MeteredBlobStoreRepository {
     ...
     */
    static final ByteSizeValue MAX_FILE_SIZE_USING_MULTIPART = new ByteSizeValue(1, ByteSizeUnit.GB);
    ...
    static final Setting<String> APP_ID = Setting.simpleString("app_id");
    ...
    /**
     * Constructs an COS backed repository
     */
    COSRepository(RepositoryMetadata metadata,
        ...
        String app_id = APP_ID.get(metadata.settings());
